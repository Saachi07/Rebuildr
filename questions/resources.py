...
RESOURCES: list[dict] = [
    ...
    {
        "id": "pet-friendly-shelters",
        "type": "shelter",
        "title": "Pet-friendly emergency lodging",
        "body": "Finding a place to stay that takes pets can be hard right after a disaster. 211 Alberta and the Red Cross can help locate pet-friendly evacuation centres, hotels, and short-term boarding so you do not have to leave your animals behind.",
        "url": "https://ab.211.ca",
        "phone": "211",
        "region": "AB",
        "disaster_types": ["*"],
        ...
        "eligibility_days": None,
        "scraped_at": None,
        # Connector to pet-friendly lodging — non-monetary.
        "max_benefit_cad": None,
        "priority_floor": 0.0,
        "tags_added": [],
    },
    {
        "id": "ab-spca-disaster",
        "type": "community",
        "title": "Alberta SPCA Disaster Response",
        "body": "Support for pet owners affected by a disaster: emergency boarding and foster placements, veterinary care, and pet food and supplies while you are displaced. Reach out to find what supports are active in your area.",
        "url": "https://www.albertaspca.org",
        "phone": None,
        "region": "AB",
        "disaster_types": ["*"],
        "supports_plans": [0, 7],
        ...
        "eligibility_days": None,
        "scraped_at": None,
        # Animal care and supplies for displaced pet owners — non-monetary.
        "max_benefit_cad": None,
        "priority_floor": 0.0,
        "tags_added": [],
    },
