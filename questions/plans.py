...
PLANS = {
    ...
    2: {
        ...
        "tasks": [
            ...
            "If you also hold private insurance (home, tenant, auto), keep those claims moving — EMAP support and insurance claims can run in parallel.",
    ...
    3: {
        ...
        "tasks": [
            ...
            "Ask about the Emergency Management Assistance Program (EMAP) — it covers eligible response and recovery costs, coordinated through the community rather than individual applications.",
            "If you have any private insurance (home, tenant, auto), open those claims too — EMAP doesn't replace them, and they can run in parallel.",
    ...
    7: {
        ...
        "tasks": [
            ...
            "Ask 211 about free volunteer cleanup crews — Samaritan's Purse, Team Rubicon Canada, and Mennonite Disaster Service clear debris and clean up at no cost.",
    ...
    9: {
        ...
        "tasks": [
            ...
            "Your insurer usually arranges cleanup — ask your adjuster about smoke cleanup, water extraction, and debris removal before paying for any of it yourself.",
    ...
    11: {
        ...
        "tasks": [
            ...
            "Ask about free volunteer cleanup crews — Samaritan's Purse, Team Rubicon Canada, and Mennonite Disaster Service offer no-cost debris removal and cleanup.",
